...
/* Aggiunge una redirection alla lista */
...
/* Conta quanti argomenti ci sono prima della prossima pipe o redirection */
...
/* Aggiunge un comando alla fine della lista */
